...
vtk_file_name = "../output/automated/HenryStat_test" -- VTK output file name base
...
print ("[henry_stat_test] Domain info:")
...
print("[henry_stat_test] ---> DoF statistics:")
...
-- apply the solver
print ("[henry_stat_test] ===> Computation of the initial guess for the pressure <===")
if not solver:apply (u) then
	print ("[henry_stat_test] ===> THE PREPARATION PHASE FAILED! <===")
	exit ()
end
...
-- apply the solver
print ("[henry_stat_test] ===> Computation of the solution of the problem <===")
if not solver:apply (u) then
	print ("[henry_stat_test] ===> SOLVER FAILED! <===")
	exit ()
end
